...
### EDA
For EDA of the categorical columns, the unique values of the column were found and then were replaced with the terms advised in the data dictionary file.
...
- the equation for interpreting the rental counts ('cnt') based on the above variables is:  
#### bike rentals ('cnt') = 0.5684 x temp -0.2425 x snow + 0.2296 x "2019" + the rest of the multipliers and features  
This means:  
